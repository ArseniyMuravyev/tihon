...
(function ($) {
  ...
  $(function () {
    ...
    $(
      '<div id="navPanel">' +
        '<div id="navLogo"><img src="/images/logo.png" /></div>' +
        '<nav>' +
        $('#nav').navList() +
        '</nav>' +
    ...
    // Customizations
    $('header nav li a, a.smooth').on('click', function (e) {
      ...
      window.location.hash = $id.selector;
    });
    ...
    var backToTop = function () {
      ...
      var windowHeight = $(window).height(),
        offset = parseInt(windowHeight * 1.5),
        $element = $('.back-to-top');

      $(window).unbind('scroll.backToTop');
      ...
      $element.unbind('click.backToTop');
      $element.bind('click.backToTop', function (e) {
        e.preventDefault();
